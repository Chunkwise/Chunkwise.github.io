...
<LottieAnimation
  src="create_workflow.lottie"
  alt="An animated diagram showing the request flow for workflow creation"
  aspectRatio="3208 / 493"
/>
...
<LottieAnimation
  src="upload_document.lottie"
  alt="An animated diagram showing the request flow for document upload and normalization"
  aspectRatio="3208 / 493"
/>
...
<LottieAnimation
  src="visualization.lottie"
  alt="An animated diagram showing the request flow for chunk visualization"
  aspectRatio="3208 / 2293"
/>
...
<LottieAnimation
  src="evaluation.lottie"
  alt="An animated diagram showing the request flow for chunk evaluation"
  aspectRatio="3500 / 2293"
/>
...
<LottieAnimation
  src="compare_workflows.lottie"
  alt="An animated diagram showing the request flow for workflow comparison"
  aspectRatio="3208 / 493"
/>
...
<LottieAnimation
  src="process_documents.lottie"
  alt="An animated diagram showing the request flow for deployment of the ingestion pipeline"
  aspectRatio="3210 / 2293"
/>
