...
<iframe
  src="https://player.mux.com/fBu9YwLRDJQFyo8KTjhKZ263RtBPHygxlLSB1Uo2gjI?autoplay=true&loop=true&muted=true&accent-color=%2303B9F4"
...
<ZoomedDiagram
  src="evals/token_retrieval_and_precision_recall.png"
  alt="True/False Positives/Negatives for Token Retrieval, and  True Positives / Total Retrieved, Recall: True Positives / Total Relevant"
/>
...
<ZoomedDiagram
  src="evals/inversion_over_union.png"
